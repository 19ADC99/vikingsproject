...
To identify potential regions affected by Loss-Of-Heterozygosity, we measured the average number of SNPs along a 10kb sliding window for each of the Farmhouse yeasts isolates, and selected brewing yeasts from the set published by Gallone et al. 2019. We could not identify any region in the Farmhouse yeasts genomes suggesting any LOH event.
...
We have sequenced 5 distinct isolated from culture #28 (Central East Norway). As we will see in @sec-phylogeny-and-population-structure, 

two lineages with  with 37 intersperced in them
...
Based on the analysis of Farmhouse yeasts SNPs we have learnt:

* Farmhouse yeasts contains a high degree of Heterozygosity when compared to the other breweing yeasts, similar to yeast strains from the “mixed” Clade.
* We could not identify any lineage-specific region with evident Loss-Of-Heterozygosity.
* 
