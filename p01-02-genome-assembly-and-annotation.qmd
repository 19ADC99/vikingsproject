...
DT::datatable(
  HGT_genes,
  extensions = c("FixedColumns", "FixedHeader"),
  caption = "Table 6: HGT Zygosaccharomzces parabailli operon.", 
  plugins = "ellipsis",
  options = list(
...
#| warning: FALSE
#| fig.height: 6
#| fig.cap: '[Figure 3: Dotplot of overrepresented BP terms in Zygosaccharomzces parabailli transferred operon.]{style="color: steelblue;"}'
...
#| warning: FALSE
#| fig.height: 6
#| fig.cap: '[Figure 4: Dotplot of overrepresented MF terms in Zygosaccharomzces parabailli transferred operon.]{style="color: steelblue;"}'
